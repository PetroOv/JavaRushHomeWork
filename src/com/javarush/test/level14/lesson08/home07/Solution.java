...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        for(Apartament apart : apartaments){
            if(apart instanceof Apt1Room)
                ((Apt1Room) apart).clean1Room();
            if(apart instanceof  Apt2Room)
                ((Apt2Room) apart).clean2Rooms();
            if(apart instanceof Apt3Room)
                ((Apt3Room) apart).clean3Rooms();
        }
    }
